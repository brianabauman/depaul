...
void PerformanceTimer::privInitTimer() noexcept
{
...
LARGE_INTEGER PerformanceTimer::privGetTimer() noexcept
{
	LARGE_INTEGER time;
...
void PerformanceTimer::Tic() noexcept
{
	// Forces a Fence... 
	printf("tic()\n");
...
void PerformanceTimer::Toc() noexcept
{
...
float PerformanceTimer::TimeInSeconds() noexcept
{
	float floatTime;
